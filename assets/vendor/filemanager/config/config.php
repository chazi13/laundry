...
$config = array(
    ...
    |
    */
    'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://". @$_SERVER['HTTP_HOST'] . str_replace('/assets/vendor/filemanager/dialog.php', '', $_SERVER['SCRIPT_NAME']) . '/assets/vendor',
    // 'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://". @$_SERVER['HTTP_HOST'] . str_replace('operator/' . basename($_SERVER['SCRIPT_NAME']), '', $_SERVER['SCRIPT_NAME']) . '/assets/vendor',
    /*
    |--------------------------------------------------------------------------
