        ...
        <form action="sistem/add_member.php" method="post">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="telp" id="telp" class="form-control" autocomplete="tel" pattern="^[08][0-9]{11,15}" title="Masukan Nomor Telpon yang valid, seperti 085774237xxx. Telp hanya bisa berisi angka" placeholder="Masukan Telp Member" required>
                </div>
                <div class="form-group">
